...
$phieuxuat->set_idphieuxuat($id);
$data_phieuxuat=$phieuxuat->getdata();
// lay cac bien
$bophan = $data_phieuxuat['BoPhan'];
$so = $id;
$no=$data_phieuxuat['No'];
$co=$data_phieuxuat['Co'];
$hoten=$data_phieuxuat['NguoiNhan'];
$diachi=$data_phieuxuat['DiaChi'];
$sodienthoai=$data_phieuxuat['DienThoai'];
$lydoxuatkho=$data_phieuxuat['LyDoXuat'];
$xuattaikho=$data_phieuxuat['XuatTaiKho'];
$tongtien=$data_phieuxuat['TongTien'];
/////
...
<body>
<form action="phieuxuatkho_xuat_xemlai.php?id=<?php echo $id;?>" method="post" name="frm" enctype="multipart/form-data" >
<div id="xk_top">
	<div id="xk_left">
...
<p><font style="font-size:20px;font-weight:900;">PHIẾU XUẤT KHO</font></p>
    ...
    <div id="xk_right" >
          ...
          <p>Nợ: <input type="hidden" name="txtno" size="10" class="right" value="<?php echo $no;?>" /><?php if($no==0)echo "...................."; else echo $no;?></p>
          <p>Có: <input type="hidden" name="txtco" size="10" class="right" value="<?php echo $co;?>" /><?php if($co==0)echo "....................";else echo $co;?></p>
      ...
      <table width="640px">
        ...
        <?php
						...
						$chitiet->set_idphieuxuat($id);
						$data_chitiet=$chitiet->listchitietphieuxuat();						
						if($data_chitiet==0)
							echo "<tr>
        ...
        <tr>
          ...
          <td class='info1'width="130px" align="center"><?php echo xulygia($tongtien);?></td>
        </tr>
      </table>     
<div id="xk_bottom">
    <p><strong>Tổng số tiền</strong> (viết bằng chữ): <?php echo doc_so($tongtien);?></p>
...
<br/>
	<input type="submit" name='in' value="In Phiếu" /><input type='submit' name='dong' value='Đóng'/>  
</div>
 </form>
