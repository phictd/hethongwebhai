...
require_once('../../../libraries/donhang.php');
	...
	if($data_donhang==0) echo "<tr><td colspan='11'> <div align='center'>Không có Đơn hàng nào</div> </td> </tr>";
		...
		foreach($data_donhang as $item_donhang){
			...
			echo "<td align=center width='100px'><textarea id='username$stt' readonly='readonly' cols='7' rows='1' disabled >$item_donhang[Username]</textarea></td>";
			echo "<td align=center width='70px'><input type='text' id='ngaydat$stt' value='$item_donhang[ThoiDiemDatHang]' size='7' readonly='readonly'/></td>";
			echo "<td align=center width='70px'><input type='text' id='ngaygiao$stt' value='$item_donhang[ThoiDiemGiaoHang]' size='7' /></td>";
